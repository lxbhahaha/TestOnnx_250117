...
File `demo_e2pose.py` is modified from file  [demo_E2Pose_onnx.py](https://github.com/PINTO0309/PINTO_model_zoo/blob/main/333_E2Pose/demo/demo_E2Pose_onnx.py) in PINTO.